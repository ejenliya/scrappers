...
def add_date_to_path(path: Path, folder_name: str):
    """
    ...
    """
    dated_path = path / f'{date.today().year}' / f'{date.today().month:02d}' / f'{folder_name}'
...
class EventHandler(FileSystemEventHandler):
    def __init__(self, watch_path: Path, destination_root: Path, name: str):
